			...
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						...
						<ul class="submenu">
							<CENTER><li><a href="form-basic.php">Add Doctor Details</a></li></CENTER>
							<li><a href="petient.php">Add Petient Details</a></li>
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<center><h4 class="text-blue h4">ADD DOCTOR DETAILS</h4>
							</center>
						</div>
					...
					<form action="ddata.php" method="post">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Doctor Name/Hospital</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" type="text" placeholder="Doctor Name/Hospital" name="first_name" id="first_name">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Qualification</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" placeholder="Qualification" type="varchar" id="qul" name="qul">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Experience</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="Experience" type="varchar" name="exp" id="exp" >
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Address</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="Address" type="varchar" name="addr" id="addr">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Contact No-1</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="Description" type="varchar" name="con1" id="con1">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Contact No-2</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" value="Contact 2" type="varchar" id="cont2" name="cont2">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Speciality</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control" placeholder="Speciality" type="varchar" id="spl" name="spl">
							</div>
						</div>
						<div class="form-group row">
							<label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label">Discription</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control datetimepicker" placeholder="Discription" type="varchar " name="dis" id="dis">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Prescription-1</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control date-picker" placeholder="Prescription-1" type="varchar" name="pre1" id="pre1">
							</div>
						</div>
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Prescription-2</label>
							<div class="col-sm-12 col-md-10">
								<input class="form-control month-picker" placeholder="Prescription-2" type="varchar" name="pre2" id="pre2" >
							</div>
						</div>
						<!-- <div class="form-group row">
					...
					<CENTER><input type="submit" name="password-reset-token" class="btn btn-primary"></CENTER>
					</form>
